...
function App() {
  ...
  const generatePDF = async (job) => {
    ...
    alert(`BLACKSTON HANDYMAN SERVICES - ESTIMATE GENERATED\
\
Invoice #: EST-${job.id}\
...
\
This professional estimate uses your Blackston template with:\
...
\
Please find attached your professional estimate for ${job.title}. This estimate is valid for 30 days and includes all materials, labor, and applicable taxes.\
\
...
Quality Work. Honest Price.`);
  ...
  // Navigation with gray/black theme matching invoice
  const Navigation = () => (
        ...
        <div className=\"flex justify-between items-center h-16\">
          <div className=\"flex items-center space-x-8\">
            <div className=\"flex items-center space-x-3\">
              ...
              <div>
                <div className=\"text-xl font-bold text-white\">Blackston</div>
                <div className=\"text-xs text-orange-300 font-medium\">HANDYMAN SERVICES</div>
              </div>
            </div>
          ...
          <div className=\"text-sm text-gray-300\">Quality Work. Honest Price.</div>
        </div>
      </div>
    </nav>
  );
      ...
      return (
        <div className=\"space-y-6\">
          ...
          <div className=\"bg-white rounded-lg shadow-sm border p-6\">
            ...
            <div className=\"mb-6 bg-orange-50 p-4 rounded-lg border-l-4 border-orange-600\">
