                            ...
                            {estimates.map((est) => (
                                <tr key={est.id} className="border-b border-gray-100 hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4">
                                        <span className={`px-3 py-1 rounded-full text-sm font-medium ${est.status === 'completed' ? 'bg-green-100 text-green-700' :
                ...
                {jobs.map((job) => (
                    <div key={job.id} className="bg-white rounded-lg shadow p-6">
                        ...
                        <div className="mt-4 flex justify-between">
                            <span className={`px-3 py-1 rounded text-sm font-medium ${job.status === 'completed' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'
                                }`}>
